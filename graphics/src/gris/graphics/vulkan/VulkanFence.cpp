...
VulkanFence::VulkanFence(VulkanDevice* device, bool signaled) : VulkanDeviceResource(device)
{
...
// TODO: Do this better
[[nodiscard]] const vk::Fence& VulkanFence::FenceHandle() const
{
    return m_fence.get();
}
...
// TODO: Do this better
[[nodiscard]] vk::Fence& VulkanFence::FenceHandle()
{
    return m_fence.get();
}
